...
def unconstrained_rational_quadratic_spline_joint(
    inputs,
    unnormalized_widths,
    unnormalized_heights,
    unnormalized_derivatives,
    ...
    inside_interval_mask = (inputs >= -tail_bound) & (inputs <= tail_bound)  # masking [..., T, N]
    outside_interval_mask = ~inside_interval_mask
    ...
    ind_lin = list(set(range(feature_dims)) - set(ind_circ))
